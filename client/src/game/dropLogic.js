...
export const dropLogic = ({ type, rows, room, score, setLevel, level, gameModeFromState, gravity, player, stage, setGameOver, setDropTime, hasSubmittedScore, socket, blockHitSoundRef, updatePlayerPos, playSound }) => {
